close all;
% LF_left_right_BD_NEW=load('LF_left_right_BD_NEW.mat');
...
% title('Sensitivity analysis SHMT1/SHMT2 - Low Folic Acid','FontSize',38);
% set(gca, 'FontSize', 30);
...
% 
% 
% % HF_left_right_BD_NEW=load('HF_left_right_BD_NEW.mat');
...
% xlabel('SHMT1/SHMT2','FontSize',30);
% ylabel('Score','FontSize',30);
% title('Sensitivity analysis SHMT1/SHMT2 - High Folic Acid','FontSize',38);
% set(gca, 'FontSize', 30);
...
% % % % % % % % % % % % % % % % % 
% Heatmap
HF_heatmap=load('HF_heatmap.mat');
figure;
HF_heatmap_error_matrix = HF_heatmap.HF_heatmap.error_matrix;
HF_heatmap_error_matrix((HF_heatmap.HF_heatmap.exitflag_matrix~=1)&(HF_heatmap.HF_heatmap.exitflag_matrix~=2)&(HF_heatmap.HF_heatmap.exitflag_matrix~=-3)) = nan;
h=heatmap(SHMT2_values_For_heatmap,flip(SHMT1_values_For_heatmap),flip(HF_heatmap_error_matrix(:,1:length(SHMT2_values_For_heatmap))));
% ylabel('SHMT1','FontSize',30);
% xlabel('SHMT2','FontSize',30);
% title('Heatmap of MFA score - SHMT1 vs SHMT2 (High Folic Acid)','FontSize',30);
h.title('High Folic Acid - Heatmap of MFA score - SHMT1 vs (SHMT2-Folate secretion)');
...
% Surface
figure;
h=surf(SHMT2_values_For_heatmap,SHMT1_values_For_heatmap,HF_heatmap_error_matrix(:,1:length(SHMT2_values_For_heatmap)));
ylabel('SHMT1','FontSize',30);
xlabel('(SHMT2-Folate secretion)','FontSize',30);
title('High Folic Acid - Surface of MFA score - SHMT1 vs (SHMT2-Folate secretion)','FontSize',30);
set(gca, 'FontSize', 30);
% boolean heatmap
figure;
HF_error_matrix_within_confidence_intervals=double((HF_heatmap_error_matrix<(min(min(HF_heatmap_error_matrix+3.84)))));
h=heatmap(SHMT2_values_For_heatmap,flip(SHMT1_values_For_heatmap),flip(HF_error_matrix_within_confidence_intervals(:,1:length(SHMT2_values_For_heatmap))));
h.title('High Folic Acid - SHMT1 vs (SHMT2-Folate secretion) 95% confidence intervals');
h.xlabel('(SHMT2-Folate secretion)');
h.ylabel('SHMT1');
...
% % % % % % % % % % % % % % % % % 
% Heatmap
LF_heatmap=load('LF_heatmap.mat');
figure;
LF_heatmap_error_matrix = LF_heatmap.LF_heatmap.error_matrix;
LF_heatmap_error_matrix((LF_heatmap.LF_heatmap.exitflag_matrix~=1)&(LF_heatmap.LF_heatmap.exitflag_matrix~=2)&(LF_heatmap.LF_heatmap.exitflag_matrix~=-3)) = nan;
h=heatmap(SHMT2_values_For_heatmap,flip(SHMT1_values_For_heatmap),flip(LF_heatmap_error_matrix(:,1:length(SHMT2_values_For_heatmap))));
% ylabel('SHMT1','FontSize',30);
% xlabel('SHMT2','FontSize',30);
% title('Heatmap of MFA score - SHMT1 vs SHMT2 (Low Folic Acid)','FontSize',30);
h.title('Low Folic Acid - Heatmap of MFA score - SHMT1 vs (SHMT2-Folate secretion)');
h.xlabel('(SHMT2-Folate secretion)');
h.ylabel('SHMT1');
h.CellLabelColor = 'black';
set(gca, 'FontSize', 30);
% Surface
figure;
h=surf(SHMT2_values_For_heatmap,SHMT1_values_For_heatmap,LF_heatmap_error_matrix(:,1:length(SHMT2_values_For_heatmap)));
ylabel('SHMT1','FontSize',30);
xlabel('(SHMT2-Folate secretion)','FontSize',30);
title('Low Folic Acid - Surface of MFA score - SHMT1 vs (SHMT2-Folate secretion)','FontSize',30);
set(gca, 'FontSize', 30);
% boolean heatmap
figure;
LF_error_matrix_within_confidence_intervals=double((LF_heatmap_error_matrix<(min(min(LF_heatmap_error_matrix+3.84)))));
h=heatmap(SHMT2_values_For_heatmap,flip(SHMT1_values_For_heatmap),flip(LF_error_matrix_within_confidence_intervals(:,1:length(SHMT2_values_For_heatmap))));
h.title('Low Folic Acid - SHMT1 vs (SHMT2-Folate secretion) 95% confidence intervals');
h.xlabel('(SHMT2-Folate secretion)');
h.ylabel('SHMT1');
h.CellLabelColor = 'none';
set(gca, 'FontSize', 30);
...
% HF_error_matrix_within_confidence_intervals_resize_smooth = zeros(size(HF_error_matrix_within_confidence_intervals)*RESIZE_FACTOR);
% LF_error_matrix_within_confidence_intervals_resize_smooth = zeros(size(LF_error_matrix_within_confidence_intervals)*RESIZE_FACTOR);
% HF_error_matrix_within_confidence_intervals_resize_smooth(HF_error_matrix_within_confidence_intervals_resize>=1)=2;
% LF_error_matrix_within_confidence_intervals_resize_smooth(LF_error_matrix_within_confidence_intervals_resize>=0.5)=1;
% error_matrix_within_confidence_intervals=HF_error_matrix_within_confidence_intervals_resize_smooth+LF_error_matrix_within_confidence_intervals_resize_smooth;
% figure;
% map=[0.7 0.7 0.7;0.15 0.44 0;0 0.44 0.73];
% c=colormap(map);
% h=heatmap(SHMT2_values_For_heatmap,flip(SHMT1_values_For_heatmap),flip(error_matrix_within_confidence_intervals(:,1:length(SHMT2_values_For_heatmap))),'colormap',c);
